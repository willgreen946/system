...
let s:p.normal.left = [ [ s:white, s:green ], [ s:white, s:gray ] ]
let s:p.normal.middle = [ [ s:silver, s:black ] ]
let s:p.normal.right = [ [ s:white, s:green ], [ s:white, s:gray ] ]
...
let s:p.replace.left = [ [ s:white, s:green ], [ s:white, s:gray ] ]
let s:p.replace.right = copy(s:p.replace.left)
let s:p.visual.left = [ [ s:white, s:green ], [ s:white, s:gray ] ]
